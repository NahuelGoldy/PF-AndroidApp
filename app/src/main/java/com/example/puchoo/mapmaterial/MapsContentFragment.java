...
public class MapsContentFragment extends FragmentActivity
        implements TimePicker.OnTimeChangedListener, NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maps_content_fragment);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            pedirPermisosUbicacion(ConstantePermisos.getPermisoFineLocationParaMapaReady());
            cargarMapa();
        }
        else{
            cargarMapa();
    ...
    public void cargarMapa(){
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            mMap.setInfoWindowAdapter(ventanaInfo);
    ...
    public Marker agregarMarcadorEstacionamiento(UbicacionVehiculoEstacionado estacionamiento) {
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(estacionamiento.getCoordenadas(), 15));
    ...
    private void enfocarMapaEnUbicacion(Location location){
        ...
        if(location!=null){
           ...
           /* LatLng target = new LatLng(location.getLatitude(), location.getLongitude());
            ...
            //Muevo la camara
            mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(location.getLatitude(),location.getLongitude()),17f),200,null);
